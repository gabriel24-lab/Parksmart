...
(function (global) {
  ...
  function onTS(e) {
    ...
    if (e.touches.length === 1) {
      S.dragging = true;
      lastPinch = null;
      S.sx = e.touches[0].clientX - S.ox;
      S.sy = e.touches[0].clientY - S.oy;
  ...
  function onTM(e) {
    ...
    if (e.touches.length === 1 && S.dragging) {
      var c = clamp(
        e.touches[0].clientX - S.sx,
        e.touches[0].clientY - S.sy,
        S.scale,
      );
      S.ox = c.x;
      S.oy = c.y;
