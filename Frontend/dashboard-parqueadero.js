  ...
  <tr>
    ...
    async function loadPerfil() {
      try {
        ...
        const tipoLabels = { TI: 'Tarjeta de Identidad', CC: 'Cédula de Ciudadanía' };
        const tipoDisplay = document.getElementById('p-tipo-id-display');
        if (tipoDisplay) tipoDisplay.value = tipoLabels[data.data.tipo_id] || data.data.tipo_id || '';
    ...
    async function saveProfile() {
      ...
      try {
        ...
        Auth.save({
          ...
          user: { ...user, nombre_completo: nombre, email: email, tipo_id, numero_id: num_id, id_centro: centro || null, id_region: region || null },
        });
