...
router.put('/perfil',
  ...
  async (req, res) => {
    ...
    const { nombre_completo, tipo_id, numero_id, id_centro, rol } = req.body;
    ...
    try {
      ...
      await query(
        ...
        { nombre: nombre_completo, tipo_id, nid: numero_id, centro: id_centro || null, rol: rol || null, uid: req.user.id_usuario }
      );
